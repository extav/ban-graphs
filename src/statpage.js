...
import {
  ...
  createPageStructure();
  const infoText =
    "This is A COMPLETE TEST OF MY SECOND PAGE. I make no promises that things aren't broken, but maybe you can have some fun looking at the data like I have. I'll probably add features, pages, and general improvements over time to make it less scuffed. Or maybe I won't. Enjoy. -Extav";
